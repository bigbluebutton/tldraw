## API Report File for "@bigbluebutton/editor"
...
import { computed } from '@bigbluebutton/state'
import { ComputedCache } from '@bigbluebutton/store'
...
import { ShapeProps } from '@bigbluebutton/tlschema'
...
import { TLAsset } from '@bigbluebutton/tlschema'
import { TLAssetId } from '@bigbluebutton/tlschema'
import { TLAssetPartial } from '@bigbluebutton/tlschema'
import { TLBaseShape } from '@bigbluebutton/tlschema'
import { TLBookmarkAsset } from '@bigbluebutton/tlschema'
import { TLCamera } from '@bigbluebutton/tlschema'
import { TLCursor } from '@bigbluebutton/tlschema'
import { TLCursorType } from '@bigbluebutton/tlschema'
import { TLDefaultHorizontalAlignStyle } from '@bigbluebutton/tlschema'
import { TLDocument } from '@bigbluebutton/tlschema'
import { TLGroupShape } from '@bigbluebutton/tlschema'
import { TLHandle } from '@bigbluebutton/tlschema'
import { TLImageAsset } from '@bigbluebutton/tlschema'
import { TLInstance } from '@bigbluebutton/tlschema'
import { TLInstancePageState } from '@bigbluebutton/tlschema'
import { TLInstancePresence } from '@bigbluebutton/tlschema'
import { TLPage } from '@bigbluebutton/tlschema'
import { TLPageId } from '@bigbluebutton/tlschema'
import { TLParentId } from '@bigbluebutton/tlschema'
...
import { TLShapePartial } from '@bigbluebutton/tlschema'
import { TLStore } from '@bigbluebutton/tlschema'
import { TLStoreProps } from '@bigbluebutton/tlschema'
import { TLUnknownShape } from '@bigbluebutton/tlschema'
import { TLVideoAsset } from '@bigbluebutton/tlschema'
import { track } from '@bigbluebutton/state'
import { transact } from '@bigbluebutton/state'
import { transaction } from '@bigbluebutton/state'
import { UnknownRecord } from '@bigbluebutton/store'
import { useComputed } from '@bigbluebutton/state'
import { useQuickReactor } from '@bigbluebutton/state'
import { useReactor } from '@bigbluebutton/state'
import { useValue } from '@bigbluebutton/state'
import { Vec2dModel } from '@bigbluebutton/tlschema'
import { whyAmIRunning } from '@bigbluebutton/state'
...
// @public (undocumented)
export function Canvas({ className }: { className?: string }): JSX_2.Element
...
export class Editor extends EventEmitter<TLEventMap> {
	...
	updateCurrentPageState(
		partial: Partial<
			Omit<TLInstancePageState, 'editingShapeId' | 'focusedGroupId' | 'pageId' | 'selectedShapeIds'>
		>,
		historyOptions?: TLCommandHistoryOptions
	): this
...
export class ErrorBoundary extends React_3.Component<
	React_3.PropsWithRef<React_3.PropsWithChildren<TLErrorBoundaryProps>>,
...
// @public (undocumented)
export function ErrorScreen({ children }: { children: any }): JSX_2.Element
...
// @internal (undocumented)
export function getRotationSnapshot({ editor }: { editor: Editor }): null | TLRotationSnapshot
...
// @public
export function hardReset({ shouldReload }?: { shouldReload?: boolean | undefined }): Promise<void>
...
// @public (undocumented)
export function LoadingScreen({ children }: { children: any }): JSX_2.Element
...
// @public (undocumented)
export const PositionedOnCanvas: MemoExoticComponent<
	({
		x: offsetX,
		y: offsetY,
		rotation,
...
export function releasePointerCapture(
	element: Element,
	event: PointerEvent | React_2.PointerEvent<Element>
): void
