## API Report File for "@bigbluebutton/state"
...
export function computed<Value, Diff = unknown>(
	name: string,
	compute: (
		previousValue: typeof UNINITIALIZED | Value,
...
export function track<T extends FunctionComponent<any>>(
	baseComponent: T
): T extends React_2.MemoExoticComponent<any> ? T : React_2.MemoExoticComponent<T>
